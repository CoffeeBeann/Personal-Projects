...
main:
	...
	// Initialize inner& outer counter to 1
	mov x21, 0
...
forMain:
	...
	//Load Array Pointer to x0 
	ldur x0,[sp, 8]
	mov x1, x21 // x1 = i
	bl	showLEDsFromArray
	
	// move args for testplayer func
	ldur x0,[sp, 8]
	mov x1, x21 // x1 = i

	bl	testPlayerFromArray
...
testPlayerFromArray:
	...
	stur lr,[sp, 0] // save LR
	stur x0,[sp, 8] // save ArrayPointer
	stur x1,[sp, 16] // save ArrayLength
...
forTestLoop:
	...
	// Load registers for use
	ldur x2,[sp, 8] // x2 = arrayPointer
	
	// LED = arrayPointer[ii]
	lsl x1, x1, 3 // ii *= 8
	add x1, x1, x2 // ii += arrayPointer
	ldur x3,[x1, 0] // LED = arrayPointer[ii]
